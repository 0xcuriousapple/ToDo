      ...
      <Grid item md={12} className={classes.filterclass}>
        ...
        {props.filters.today ? (
          ...
          <Chip
            ...
            label="Today"
            color="primary"
            onClick={() => props.handleClickToday({ date: props.getToday() })}
            className={classes.chips}
          />
        )}
        {props.filters.tom ? (
          <Chip
            ...
            label="Tomorrow"
            color="primary"
            onClick={() => props.handleClickTom({ date: props.getTomorrow() })}
            className={classes.chips}
          />
        ) : (
          <Chip
        ...
        {props.filters.seldate ? (
          <Chip
            ...
            color="primary"
            onClick={() =>
              props.handleClickSelectedDate({ date: props.selecteddatefilter })
            }
            className={classes.chips}
          />
        ) : (
